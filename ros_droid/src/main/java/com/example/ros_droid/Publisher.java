 ...
 * example, if the ROS message type is "std_msgs/String" then msg should be a {@link com.example.ros_droid.msgs.std_msgs.PrimitiveMsg}
...
public class Publisher {
     ...
     * @param rosBridge the {@link com.example.ros_droid.RosBridge} that manages ROS Bridge interactions.
     */
    ...
    /**
     * Returns the {@link com.example.ros_droid.RosBridge} object that manages the connection to the ROS Bridge server.
     * @return the {@link com.example.ros_droid.RosBridge} object that manages the connection to the ROS Bridge server.
     */
