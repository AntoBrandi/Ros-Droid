package com.example.ros_droid.tools;
...
public class PeriodicPublisher {
    ...
    /**
     * The {@link com.example.ros_droid.Publisher} to which publish calls are made
     */
    ...
    /**
     * Initializes with a {@link com.example.ros_droid.Publisher} for this action using the specified topic, message type, and {@link com.example.ros_droid.RosBridge} connection.
     * @param topic the ros topic to which messages will be published
     * @param msgType the ros message type of th target topic
     * @param rosBridge the {@link com.example.ros_droid.RosBridge} connection to use.
     */
    ...
    /**
     * Initializes with a {@link com.example.ros_droid.Publisher} for publishing action messages to ROS.
     * @param pub the {@link com.example.ros_droid.Publisher} to which to publish
     */
